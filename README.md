...
이 앱은 **Apple 서명·공증을 거치지 않은 개인 배포**라, 처음 열 때 macOS가 *"확인되지 않은 개발자"* 경고를 띄웁니다. 개인이 만들어 나누는 프로그램에 흔한 안내이며, 아래 절차로 한 번만 허용하면 됩니다. (DMG로 받아도 이 단계는 동일합니다 — 서명 문제라 포장 방식과 무관합니다.)
