...
_EN: dict[str, str] = {
    ...
    "Wiki 저장 폴더 열기": "Open wiki output folder",
    "편집 방식": "Editor layout",
    "한 장씩 편집": "One chapter at a time",
    "표로 편집": "Table editor",
    "편집할 장": "Chapter to edit",
    "순번": "Number",
    "분량": "Length",
    "시작 부분": "Opening text",
    "%s자": "%s characters",
    ...
    "이 장을 지우고 본문을 바로 앞 장 뒤에 붙입니다": "Delete this chapter file and append its text to the previous chapter.",
    "좁은 창에서는 한 장씩 편집하세요. 방식이나 장을 바꿔도 수정 내용은 저장 전까지 유지됩니다.": "Use one chapter at a time in narrow windows. Draft edits are kept when switching chapters or editor layouts until you save.",
    "합치기로 선택한 장은 저장 시 앞 장에 붙고 기존 장 파일은 삭제됩니다.": "On save, chapters marked for merging are appended to the preceding chapter and their original chapter files are deleted.",
    "위키(Vault)": "Wiki vault",
    "실패": "Failed",
    "로그": "Logs",
    "이미지 재판독": "Image rereading",
    "목차 판독": "Contents recognition",
    "자간정리": "Text cleanup",
    "글자 크기": "Text size",
    "앱을 다시 열어도 유지됩니다. 기본값은 100%입니다.": "Saved between launches. The default is 100%.",
    "창 크기는 앱을 정상 종료할 때 저장됩니다.": "Window size is saved when you close the app normally.",
    "화면과 저장 위치": "Display and storage",
    "문서출력": "Export",
    "작업 단계": "Workflow navigation",
    "설정된 AI (연결 상태 아님)": "Configured AI (not a connection check)",
    "선택한 AI 연결을 사용할 수 없습니다. 설정을 확인하세요.": "The selected AI connection is unavailable. Check Settings.",
    "AI 작업은 문서 내용을 외부 서비스로 전송합니다. 민감정보와 이용허락을 확인하세요.":
        "AI tasks send document content to external services. Check sensitive information and permissions.",
    "실패 항목 %d개": "Failed items: %d",
    "현재 문서 실패 문단 %d개": "Failed paragraphs in current document: %d",
    "완료하지 못한 항목 %d개 — 결과를 확인하고 다시 시도하세요.": "%d unfinished items — review the results and retry.",
    "미번역 문단 %d개가 남았습니다. 완료본으로 확정하지 않았습니다.": "%d untranslated paragraphs remain. The result was not marked complete.",
    "실패 항목 다시 시도": "Retry failed items",
    "생성된 Wiki 없음": "No wiki notes yet",
    "0_업로드대기": "Upload queue",
    "1_원본PDF": "Source documents",
    "2_변환TXT": "Extracted text",
    "3_챕터": "Chapters",
    "구버전보관": "Legacy archive",
    "기본 AI 설정 사용": "Use default AI settings",
    "작업별 AI 설정": "AI settings by task",
    "AI 연결": "AI connection",
    "모델": "Model",
    "모델 ID": "Model ID",
    "모델 ID 직접 입력": "Enter a model ID",
    "모델 적용": "Apply model",
    "적용 AI": "Selected AI",
    "CLI 기본 설정 따르기": "Follow CLI defaults",
    "CLI 설정값": "CLI configuration",
    "Codex가 저장한 모델 목록입니다. 실제 사용 권한은 ‘연결·모델 확인’으로 확인하세요.":
    ...
    "짧은 요청 1회로 사용 가능 여부를 확인합니다. 사용량이 소모됩니다.":
        "Sends one short test request. Uses your quota or API credits.",
    "선택한 설정으로 응답을 받았습니다.": "Received a response using the selected settings.",
    "모델 또는 로그인 설정을 확인하세요.": "Check the model and login settings.",
    "모델이 빈 응답을 반환했습니다.": "The model returned an empty response.",
    "현재 항목 후 중단": "Stop after current item",
    "중단 요청됨 — 현재 항목을 저장한 뒤 멈춥니다.": "Stop requested — the current item will be saved first.",
    "부분완료·실패 항목 재시도 (%d개)": "Retry partial or failed items (%d)",
    "성공한 문단은 재사용하고 실패한 문단부터 다시 번역합니다.":
        "Successful paragraphs are reused; failed paragraphs are retried.",
    "AI 모델 또는 로그인 문제로 멈췄습니다. 설정을 확인한 뒤 재시도하세요.":
        "Stopped due to a model or login problem. Check Settings and retry.",
    "이미지 재판독은 CLI 모델을 선택해 주세요.": "Select a CLI model for image rereading.",
    # ── 헤더 / 상태 배너 ──────────────────────────────────
